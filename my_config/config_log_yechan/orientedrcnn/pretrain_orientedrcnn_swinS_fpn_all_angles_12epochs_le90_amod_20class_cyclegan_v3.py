...
#    paramwise_cfg=dict(
#        custom_keys={
#            'backbone.stages.0': dict(lr_mult=0.0),
#        }
#    )
#)
...
train_pipeline = [
    ...
    dict(type='RResize',
        img_scale=[(640, 480), (1280, 960)], # 0.8x - 1.2x  (1x: 1920x1440)
        multiscale_mode='range'),
    dict(type='RRandomCrop', crop_size=(640, 480), allow_negative_crop=False,
    ...
    dict(type='PolyRandomRotate',
         rotate_ratio=0.3, mode='range',
         angles_range=180, auto_bound=False,
         rect_classes=None, allow_negative=False, version='le90'),
