# 🚩 DEFAULT CONFIG ####################################################################################################
dataset_type = 'AMODwithCivilianFineGrainedDataset'
...
num_classes = 26                    # AMOD -> 13, AMOD_FG -> 25 (if civilian allowed? +1!)
load_from = None
resume_from = None
...
data = dict(
    samples_per_gpu=2,
    workers_per_gpu=2,
    train=dict(type=dataset_type, data_root=data_root, ann_file='train_Half.txt', img_prefix='train', angles=angles,
