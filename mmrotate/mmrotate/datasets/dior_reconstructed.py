# reference: https://github.com/yangxue0827/h2rbox-mmrotate
...
# original: from .builder import ROTATED_DATASETS
# modified:
from mmrotate.datasets.builder import ROTATED_DATASETS

@ROTATED_DATASETS.register_module()
class DIORDatasetReconstructed(CustomDataset):
    ...
    CLASSES = ('airplane', 'ship', 'vehicle', 'windmill')

    PALETTE = [(220, 20, 60),(250, 0, 30),  (0, 82, 0), (120, 166, 157)]
    ...
    def __init__(self,
        ...
        super(DIORDatasetReconstructed, self).__init__(
    ...
    def load_annotations(self, ann_file):
        ...
        for img_id in img_ids:
            ...
            filename = osp.join(self.img_prefix, f'{img_id}.jpg')
            ...
            #                     f'{img_id}.xml')
            # print(xml_path, '++', self.img_prefix, '>>>', self.img_subdir, '<<<', self.ann_subdir)
